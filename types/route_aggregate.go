...
const (
	route_aggregate_id_perms uint64 = 1 << iota
...
func (obj *RouteAggregate) SetIdPerms(value *IdPermsType) {
        obj.id_perms = *value
        obj.modified |= route_aggregate_id_perms
}
...
func (obj *RouteAggregate) SetPerms2(value *PermType2) {
        obj.perms2 = *value
        obj.modified |= route_aggregate_perms2
}
...
func (obj *RouteAggregate) SetDisplayName(value string) {
        ...
        obj.modified |= route_aggregate_display_name
}

func (obj *RouteAggregate) readServiceInstanceRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & route_aggregate_service_instance_refs == 0) {
...
func (obj *RouteAggregate) AddServiceInstance(
        ...
        if obj.modified & route_aggregate_service_instance_refs == 0 {
...
func (obj *RouteAggregate) ClearServiceInstance() {
        if (obj.valid & route_aggregate_service_instance_refs != 0) &&
           (obj.modified & route_aggregate_service_instance_refs == 0) {
                obj.storeReferenceBase("service-instance", obj.service_instance_refs)
        }
...
func (obj *RouteAggregate) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & route_aggregate_id_perms != 0 {
        ...
        if obj.modified & route_aggregate_perms2 != 0 {
                var value json.RawMessage
        ...
        if obj.modified & route_aggregate_display_name != 0 {
                var value json.RawMessage
...
func (obj *RouteAggregate) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "id_perms":
                        ...
                        if err == nil {
                                obj.valid |= route_aggregate_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= route_aggregate_perms2
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= route_aggregate_display_name
                        }
                        break
