...
const (
	routing_policy_id_perms uint64 = 1 << iota
...
func (obj *RoutingPolicy) SetIdPerms(value *IdPermsType) {
        obj.id_perms = *value
        obj.modified |= routing_policy_id_perms
}
...
func (obj *RoutingPolicy) SetPerms2(value *PermType2) {
        obj.perms2 = *value
        obj.modified |= routing_policy_perms2
}
...
func (obj *RoutingPolicy) SetDisplayName(value string) {
        ...
        obj.modified |= routing_policy_display_name
}

func (obj *RoutingPolicy) readServiceInstanceRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & routing_policy_service_instance_refs == 0) {
...
func (obj *RoutingPolicy) AddServiceInstance(
        ...
        if obj.modified & routing_policy_service_instance_refs == 0 {
...
func (obj *RoutingPolicy) ClearServiceInstance() {
        if (obj.valid & routing_policy_service_instance_refs != 0) &&
           (obj.modified & routing_policy_service_instance_refs == 0) {
                obj.storeReferenceBase("service-instance", obj.service_instance_refs)
        }
...
func (obj *RoutingPolicy) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & routing_policy_id_perms != 0 {
        ...
        if obj.modified & routing_policy_perms2 != 0 {
                var value json.RawMessage
        ...
        if obj.modified & routing_policy_display_name != 0 {
                var value json.RawMessage
...
func (obj *RoutingPolicy) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "id_perms":
                        ...
                        if err == nil {
                                obj.valid |= routing_policy_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= routing_policy_perms2
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= routing_policy_display_name
                        }
                        break
